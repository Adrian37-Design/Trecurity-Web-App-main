    ...
    <main>
        <div class="row">
            <div class="col-md-6 p-3 border border-2 rounded mb-2 mb-sm-0">
                ...
                <div v-if="user?.approval_level === 'SUPER_ADMIN' || user?.approval_level === 'MASTER_ADMIN'" class="d-flex justify-content-between">
                    <span>Company</span>
                ...
                <div class="d-flex justify-content-between mt-1">
                    ...
                    <span>{{ (props.vehicle as any)?.total_mileage ? (props.vehicle as any)?.total_mileage + ' km' : 'No Data' }}</span>
                </div>
                <div class="d-flex justify-content-between mt-1">
                    <span>Direction</span>
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <span>Device: {{ props.vehicle?.tracking_data?.at(0)?.battery_percentage ? props.vehicle?.tracking_data?.at(0)?.battery_percentage + '%' : 'No Data' }}</span>
                </div>
                <div class="col-md-6 mt-2">
                    <i class="ti ti-car-battery me-1"></i>
                    <span>Vehicle: {{ (props.vehicle as any)?.configuration?.external_battery_voltage || props.vehicle?.tracking_data?.at(0)?.external_battery_voltage ? ((props.vehicle as any)?.configuration?.external_battery_voltage || props.vehicle?.tracking_data?.at(0)?.external_battery_voltage) + 'V' : 'No Data' }}</span>
                </div>
                <div class="d-flex justify-content-between mt-1">
                    <span>Ignition</span>
