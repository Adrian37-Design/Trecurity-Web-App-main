            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="d-flex navbar-collapse justify-content-between px-0" id="navbarNav">
                    <div class="d-flex align-items-center">
                        <div class="d-flex flex-column ms-sm-5">
                            <div class="fs-5 fw-bold">Trecurity <span class="p-tag p-component ms-2">
                                <span class="p-tag-value">{{ approval_level ? approval_level.replace(/_/g, ' ') : '' }}</span>
                            </span></div>
