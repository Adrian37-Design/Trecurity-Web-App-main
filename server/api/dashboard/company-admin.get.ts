...
export default defineEventHandler(async (event) => {
    ...
    if (!company_id) {
        ...
        return { data: {}, message: "User is not assigned to a company as admin", success: false };
    }
    ...
    console.log(`DEBUG Dashboard: company_id=${company_id}, company_admins=${company_admins}, users=${users}`);
