...
export default defineEventHandler(async (event) => {
    try {
        ...
        const { vehicle_id, number_plate, type, users, status, user_id, token } = body;
        ...
        // Update Vehicle
            ...
            // Created log
            createLog('Update', user_id, 'Vehicle', `Update vehicle ${normalizedPlate} (${vehicle.id})`)
        ...
        console.error("Vehicle Upsert Stack:", error.stack);
